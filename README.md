...
(that I moved to another repo, see https://stevenvictor.net/curvebox/ ), and I have some nurbs using a library, though I did the normal and curvature calculations myself.
